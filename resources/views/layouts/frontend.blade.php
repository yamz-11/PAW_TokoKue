...
<html lang="en">
    <head>
        ...
        <meta content="Toko Kue menjual segala macam kue seluruh dunia" name="description">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            @else 
                                <a class="nav-link active" href="{{ url('login') }}">Login Admin</a>
                            @endif
                        </li>
                        <!-- tombol serach-->
                        <li class="nav-item">
        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <h4>Sosial Media</h4>
                        <a href="https://www.facebook.com/Yama.equinox" class="text-terhubung"><i class="fab fa-facebook"></i></a>
                        <a href="https://www.instagram.com/yaamz11" class="text-terhubung"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.twitter.com/Yamabaik" class="text-terhubung"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/in/m-athallariq-wiratama-5a9547183/" class="text-terhubung"><i class="fab fa-linkedin"></i></a>
                    </div>
                </div>
            </div>
        </div>
